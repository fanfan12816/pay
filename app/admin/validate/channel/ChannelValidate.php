...
class ChannelValidate extends BaseValidate
{
    ...
    {
        return $this->only(['name','status','in_per','out_per','source','in_status']);
    }
    /**
     * @notes 新增
     */
    public function sceneAllot()
    {
        return $this->only(['mch_id','id']);
    }
    /**
     * @notes 修改商户场景
     */
    ...
    {
        return $this->only(['id','name','status','in_per','out_per','source','in_status']);
    }
    /**
     * @notes 修改密码场景
     */
